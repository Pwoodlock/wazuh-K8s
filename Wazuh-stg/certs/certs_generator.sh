...
# I have changed the below to reflect my environment for Rockfield IT Services and also in the opensearch.yml file to reflect the cert DN!!
OPENSEARCH_DN="/C=IE/ST=Carlow/L=Carlow/O=Rockfield IT Services/OU=Wazuh"
